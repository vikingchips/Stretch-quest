...
export const BUILTIN_ROUTINES: Routine[] = [
  // ── The daily primer ───────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      { exerciseId: 'step-out-side-lunge', durationSec: 30 },
      { exerciseId: 'frog-rock-liftoff', durationSec: 60 },
      { exerciseId: 'atg-split-squat', durationSec: 30 },
      { exerciseId: 'single-leg-glute-bridge', durationSec: 30 },
    ],
  },
  ...
  // ── Before running ─────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      { exerciseId: 'single-leg-glute-bridge', durationSec: 30 },
      { exerciseId: 'atg-split-squat', durationSec: 45 },
